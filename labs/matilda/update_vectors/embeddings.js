...
async function main() {
    try {
        ...
        console.log(await addCollectionContentVectorField(db, "documents"));
        console.log(await addCollectionContentVectorField(db, "products"));
        console.log(await addCollectionContentVectorField(db, "store_tasks"));
        console.log(await addCollectionContentVectorField(db, "training_topics"));
        console.log(await addCollectionContentVectorField(db, "transactions"));
