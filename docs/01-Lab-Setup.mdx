...
8.  Go to terminal windows and run below bash command to replace all variables in the repo.
    ...
    :::info
    **Remember to not commit any changes to the .env files**. Please notify the lab supervisors if you have done so by raising your hand.
...
11.  If you see below message in the console, you are ready to go! otherwise, please `Raise your hand and ask for help`.
